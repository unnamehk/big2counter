package com.unnamestudio.framework.impl;
...
import com.unnamestudio.framework.Pool;
import com.unnamestudio.framework.Input.TouchEvent;
import com.unnamestudio.framework.Pool.PoolObjectFactory;
...
public class MultiTouchHandler implements TouchHandler { 
	...
	>> MotionEvent.ACTION_POINTER_ID_SHIFT; 
				...
				case MotionEvent.ACTION_CANCEL:
					...
					touchEvent.pointer = pointerId; 
					touchEvent.x = touchX[pointerId] = (int) (event.getX(pointerIndex) * scaleX); 
					touchEvent.y = touchY[pointerId] = (int) (event.getY(pointerIndex) * scaleY); isTouched[pointerId] = false;
					touchEventsBuffer.add(touchEvent); 
					break;
				...
				case MotionEvent.ACTION_MOVE: 
					...
					for (int i = 0; i < pointerCount; i++) {
						pointerIndex = i; pointerId = event.getPointerId(pointerIndex);
						touchEvent = touchEventPool.newObject(); 
